...
public class PlaceAutocompleteAdapter
    ...
    public PlaceAutocompleteAdapter(Context context, GoogleApiClient googleApiClient,
        ...
        super(context, R.layout.item_auto_place_search, R.id.text1);
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            LogUtils.i(TAG, "Starting autocomplete query for: " + constraint);
...
//                        Toast.LENGTH_SHORT).show();
            ...
            LogUtils.i(TAG, "Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");

            // Freeze the results immutable representation that can be stored safely.
            return DataBufferUtils.freezeAndClose(autocompletePredictions);
        }
        LogUtils.e(TAG, "Google API client is not connected for autocomplete query.");
        return null;
    }
