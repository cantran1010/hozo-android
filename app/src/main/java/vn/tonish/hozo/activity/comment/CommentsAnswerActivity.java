        ...
        call.enqueue(new Callback<List<Comment>>() {
            ...
            public void onResponse(Call<List<Comment>> call, Response<List<Comment>> response) {
                ...
                if (response.code() == Constants.HTTP_CODE_OK) {
                    ...
                    Utils.blockUser(CommentsAnswerActivity.this);
                } else {
                    APIError error = ErrorUtils.parseError(response);
                    LogUtils.d(TAG, "errorBody" + error.toString());
                    Utils.showLongToast(CommentsAnswerActivity.this, error.message(), false, true);
                }
            }
            ...
            public void onFailure(Call<List<Comment>> call, Throwable t) {
                ...
                DialogUtils.showRetryDialog(CommentsAnswerActivity.this, new AlertDialogOkAndCancel.AlertDialogListener() {
                    @Override
...
//                    commentsAdapter.notifyDataSetChanged();
                    ...
                    if (error.status().equals(Constants.DUPLICATE_COMMENT)) {
                        DialogUtils.showOkDialog(CommentsAnswerActivity.this, getString(R.string.error), getString(R.string.comment_duplicate_error), getString(R.string.ok), new AlertDialogOk.AlertDialogListener() {
                            @Override
                            public void onSubmit() {
                        ...
                        DialogUtils.showOkDialog(CommentsAnswerActivity.this, getString(R.string.offer_system_error), error.message(), getString(R.string.ok), new AlertDialogOk.AlertDialogListener() {
                            @Override
                            public void onSubmit() {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PICK_IMAGE
            ...
            Utils.displayImage(CommentsAnswerActivity.this, imgAttached, imgPath);
    ...
    private void permissionGranted() {
        PickImageDialog pickImageDialog = new PickImageDialog(CommentsAnswerActivity.this);
        pickImageDialog.setPickImageListener(new PickImageDialog.PickImageListener() {
            ...
            public void onGallery() {
                Intent intent = new Intent(CommentsAnswerActivity.this, AlbumActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_attached:
                Intent intent = new Intent(CommentsAnswerActivity.this, PreviewImageActivity.class);
