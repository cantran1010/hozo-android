...
public class LocationMapActivity extends BaseActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    protected void initData() {
        miniTasks = getIntent().getParcelableArrayListExtra(Constants.LOCATION_TASK);
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                Intent intent = new Intent(LocationMapActivity.this, DetailTaskActivity.class);
