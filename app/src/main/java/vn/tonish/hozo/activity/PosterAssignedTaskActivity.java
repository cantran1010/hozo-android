...
public class PosterAssignedTaskActivity extends BaseActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.img_attach:
                PickImageDialog pickImageDialog = new PickImageDialog(PosterAssignedTaskActivity.this);
            ...
            case R.id.img_attached:
                Intent intent = new Intent(PosterAssignedTaskActivity.this, PreviewImageActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PICK_IMAGE
            ...
            Utils.displayImage(PosterAssignedTaskActivity.this, imgAttached, imgPath);
