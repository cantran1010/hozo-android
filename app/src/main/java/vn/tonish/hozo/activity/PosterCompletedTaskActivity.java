...
public class PosterCompletedTaskActivity extends BaseActivity implements OnMapReadyCallback, View.OnClickListener {
        ...
        ApiClient.getApiService().getDetailTask(UserManager.getUserToken(), taskId).enqueue(new Callback<TaskResponse>() {
            ...
            public void onResponse(Call<TaskResponse> call, Response<TaskResponse> response) {
                ...
                if (response.code() == Constants.HTTP_CODE_OK) {
                    ...
                    DialogUtils.showRetryDialog(PosterCompletedTaskActivity.this, new AlertDialogOkAndCancel.AlertDialogListener() {
                        @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.img_attach:
                PickImageDialog pickImageDialog = new PickImageDialog(PosterCompletedTaskActivity.this);
                pickImageDialog.setPickImageListener(new PickImageDialog.PickImageListener() {
                    ...
                    public void onGallery() {
                        Intent intent = new Intent(PosterCompletedTaskActivity.this, AlbumActivity.class);
            ...
            case R.id.img_attached:
                Intent intent = new Intent(PosterCompletedTaskActivity.this, PreviewImageActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PICK_IMAGE
            ...
            Utils.displayImage(PosterCompletedTaskActivity.this, imgAttached, imgPath);
