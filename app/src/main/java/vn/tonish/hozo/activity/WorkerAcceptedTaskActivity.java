...
public class WorkerAcceptedTaskActivity extends BaseActivity implements OnMapReadyCallback, View.OnClickListener {

    private static final String TAG = WorkerAcceptedTaskActivity.class.getSimpleName();
...
//    private Work work;
    ...
    protected int getLayout() {
        return R.layout.worker_accepted_task_activity;
    }
