...
import vn.tonish.hozo.utils.ExpandableLayout;
import vn.tonish.hozo.utils.ExpandableLayoutListener;
import vn.tonish.hozo.utils.Utils;


/**
 * Created by CanTran on 9/22/17.
 */

public class HozoExpandableRelativeLayout extends RelativeLayout implements ExpandableLayout {
    ...
    public HozoExpandableRelativeLayout(final Context context) {
        this(context, null);
    }

    public HozoExpandableRelativeLayout(final Context context, final AttributeSet attrs) {
