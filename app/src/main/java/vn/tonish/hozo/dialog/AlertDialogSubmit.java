...
public class AlertDialogSubmit extends BaseDialog implements View.OnClickListener {
    ...
    public AlertDialogSubmit(@NonNull Context context, String title, String content, String submit, AlertDialogListener alertDialogListener) {
        super(context);
        this.title = title;
    ...
    protected int getLayout() {
        return R.layout.dialog_alert_submit;
    }
